...
public class Remove_Employee {
    ...
    Remove_Employee(){
        ...
        l1=new JLabel();
        l1.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee/icons/add1.jpg"));
        ...
        b.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                try{
                    conn con = new conn();
                    String str = "SELECT EMPLOYEE_NAME,PHONE,EMAIL FROM employee WHERE EMPLOYEE_ID = '"+t.getText()+"';";
        ...
        b2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                try{
                    ...
                    conn con = new conn();
                    String str = "DELETE FROM employee WHERE EMPLOYEE_ID = '"+t.getText()+"';";
