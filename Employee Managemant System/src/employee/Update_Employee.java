...
public class Update_Employee {
        ...
        b.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                try{
                    ...
                    conn con = new conn();
                    String str = "UPDATE employee SET EMPLOYEE_NAME = '"+t1.getText()+"',DATE_OF_BIRTH = '"+t2.getText()+"',ADDRESS = '"+t3.getText()+"',EDUCATION = '"+t4.getText()+"',JOB = '"+t5.getText()+"',EMPLOYEE_ID = '"+t6.getText()+"',FATHER_NAME = '"+t7.getText()+"',MOTHER_NAME = '"+t8.getText()+"',SALARY = '"+t9.getText()+"',PHONE = '"+t10.getText()+"',EMAIL = '"+t11.getText()+"',NATIONAL_ID = '"+t12.getText()+"' WHERE EMPLOYEE_ID = '"+t6.getText()+"';";
    ...
    void showData(String x){
        try{
                    ...
                    conn cc = new conn();
                    String str = "SELECT * FROM employee WHERE EMPLOYEE_ID = '"+x+"';";
