...
public class Add_Student {
    ...
    Add_Student(){
        ...
        id14 = new JLabel("New Student Details");
        ...
        b.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                String batch = t5.getText();
                String sid = t6.getText();
                String father = t7.getText();
                String mother = t8.getText();
                String blood = t9.getText();
                String phone = t10.getText();
                String email = t11.getText();
                String nation = t12.getText();
                
                try{
                    
                    conn cc = new conn();
                    String q = "insert into student values('"+sid+"','"+name+"','"+blood+"','"+add+"','"+dep+"','"+batch+"','"+father+"','"+mother+"','"+dob+"','"+phone+"','"+email+"','"+nation+"')";
